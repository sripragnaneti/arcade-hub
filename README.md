...
*   **Aesthetic UI System**: A premium design system featuring:
    *   **Glassmorphism**: Translucent, blurred containers for a high-end terminal feel.
    *   **Dynamic Theme System**: A primary dark mode and a specialized "Yellow Cream" light mode.
    *   **Abort Sequence**: Consistent, intuitive navigation to return to the hub at any stage.
